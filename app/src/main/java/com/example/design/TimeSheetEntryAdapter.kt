...
class TimeSheetEntryAdapter(context: Context, private val entries: List<TimeSheetEntry>) :
    ArrayAdapter<TimeSheetEntry>(context, R.layout.list_item_timesheet_entry, entries) {

    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        var view = convertView
        if (view == null) {
            val inflater = LayoutInflater.from(context)
            view = inflater.inflate(R.layout.list_item_timesheet_entry, parent, false)
        }
